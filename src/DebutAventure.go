...
func (p *Player) Massure() {
	...
	case "1":
		...
		time.Sleep(500 * time.Millisecond)
		fmt.Println("\033[94m", p.name, "\033[0m", "- Bonjour, je suis un peu perdu, sauriez-vous où ")
		fmt.Println("se situe la ville la plus proche ?")
		time.Sleep(500 * time.Millisecond)
		...
		time.Sleep(500 * time.Millisecond)
		fmt.Println("\033[93mVieil Homme\033[0m - Ah ! La ville, et bien vous avez la ville d'Alyoli")
		fmt.Println(" si vous continuez plus au sud.")
		time.Sleep(500 * time.Millisecond)
...
func (p *Player) Ruisseau() {
	...
	case "1":
		...
		case "1":
			...
			time.Sleep(500 * time.Millisecond)
			fmt.Println("piquent à tout deux grandement votre interêt.")
			time.Sleep(500 * time.Millisecond)
			fmt.Println("Il ne me reste qu'à vous souhaiter à vous joueur ...\033[0m")
			time.Sleep(500 * time.Millisecond)
			fmt.Println(" ")
